...
public class Ghost : MonoBehaviour
{
    ...
    //Almacen la posición a la que se dirige el fantasma
    private Vector3 _posToGo;
    // Indice para controlar en qué posición (casilla) del "array" estoy
    private int _i;
    private Ray _ray;
    ...
    private void ChangePosition() 
    {
        ...
        {
            //Comparar si estamos en la última posición del array
            if (_i == _positionsArray.Length - 1) 
            {
                
                // Volvemos a la posición inicial del array
                _i = 0;
                _posToGo = _positionsArray[_i].position;
